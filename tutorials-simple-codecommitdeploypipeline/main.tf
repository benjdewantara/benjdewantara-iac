...
locals {
  friendlyname = "codecommitdeploypipeline"
}
...
resource "aws_codedeploy_deployment_group" "this" {
  ...
  deployment_group_name = "codedeploy-deplgroup-test"
  service_role_arn      = aws_iam_role.codedeploy-service.arn

  ec2_tag_set {
    ec2_tag_filter {
      key   = "Name"
      value = "ec2-${local.friendlyname}"
      type  = "KEY_AND_VALUE"
    }
  }
...
resource "aws_iam_role" "codepipeline-service" {
  name = "iamr-codepipeline-service"
...
resource "aws_codepipeline" "this" {
  name     = "codepipeline-${local.friendlyname}"
  role_arn = aws_iam_role.codepipeline-service.arn
  ...
  artifact_store {
    location = "codepipeline-ap-southeast-1-668961988845"
    type     = "S3"

    # encryption_key {
    #   id   = "arn:aws:kms:ap-southeast-1:948541605465:key/0552b43b-1c19-4ead-ae9c-17bf6d0e2447"
    #   type = "KMS"
    # }
  }
}
